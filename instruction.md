...
You can modify anything inside compute_pairwise_distances, but do not change its function signature or import new external libraries beyond what is already available in the repo.
